...
Hamlet & en & $\sim$15 & Acts~1--3 & Acts~4--5 \\
...
merging. Equivalently, $M$ (off-diagonal) and the communication graph are two
weighted graphs over the same cast; we quantify how closely the shared-memory
topology matches the interaction topology. \todo{report Pearson/Spearman $r$ per
scenario for $M_{ij}$ vs.\ comm frequency and vs.\ co-location; matrix-level
correlation of the $M$ graph against the communication graph; heatmap figure of
$M$; scatter of $M_{ij}$ vs.\ comm and co-location.}
